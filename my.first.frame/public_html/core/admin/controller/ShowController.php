...
class ShowController extends BaseAdmin
{
    ...
    protected function inputData()
    {
        ...
        //get_defined_vars() - функция возвращает все переменные из области видимости
    ...
    protected function createData($arr = [])
    {
        ...
        if($arr['order'])
        {
            ...
            {
                $order = Settings::instance()->arrayMergeRecursive($fields, $arr['order']);
            }else{
                $fields[] = $arr['order'];
            }
        }
        if($arr['order_direction'])
        {
            ...
            {
                $order_direction = Settings::instance()->arrayMergeRecursive($order_direction,
                    $arr['order_direction']);
            }else{
                $fields[] = $arr['order_direction'];
            }
        }
