...
class Model extends BaseModel
{
    ...
    public function showForeignKeys($table, $key = false)
    {
        ...
        $query = "SELECT COLUMN_NAME, REFERENCED_TABLE_NAME, REFERENCED_COLUMN_NAME FROM 
                    information_schema.KEY_COLUMN_USAGE WHERE TABLE_SCHEMA = '$db' 
                        AND TABLE_NAME = '$table' AND CONSTRAINT_NAME <> 'PRIMERY' AND  
    ...
    // метод для обновления позиции объекта в БД
    public function updateMenuPositionAdmin($table, $row, $where, $end_pos, $update_rows = [])
    {
